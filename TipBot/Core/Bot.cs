...
namespace TipBot {
    public class Bot {
        ...
        public Bot() {
            ...
            _commands.AddTypeReader(typeof(IUser), new Commands.UserTypeReaderExtended<IUser>());
            DiscordClient.Log += Logger.Log;
            DiscordClient.MessageReceived += HandleCommandAsync;
            DiscordClient.ReactionAdded += ReactionFocus.HandleHelpReactions;
        ...
        public static async Task<IUser> GetUser(ulong userId) => await DiscordClient.Rest.GetUserAsync(userId);
